...
public class NavegacaoMenuSala {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Entrei na tela de cadastro de sala!");
        Thread.sleep(2000);
        ...
        System.out.println("Fui para a tela de cadastrar salas novamente!");
        Thread.sleep(2000);
        ...
        System.out.println("Entrei na tela de listar salas!");
        Thread.sleep(2000);
        ...
        //Ir para a próxima posterior novamente
        driver.navigate().forward();
        System.out.println("Voltei para a tela de listar salas novamente!");
        Thread.sleep(2000);
